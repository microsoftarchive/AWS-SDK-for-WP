...
/*******************************************************************************
 *  AWS SDK for Windows Phone 7
 *  API Version: 2011-05-22
 */
...
namespace Amazon.SQS
{
    ...
    {
        /// <summary>
        /// Event to handle the response of SQS Requests
        /// The reponse can be a valid result or any AmazonSQSException
        /// </summary>
        event SQSResponseEventHandler<object, ResponseEventArgs> OnSQSResponse;
    ...
    {
        /// <summary>
        /// Gets the <see cref="ISQSResponse"/> object.
        /// </summary>
        public ISQSResponse Response { get; private set; }
        public ResponseEventArgs(ISQSResponse response)
        {
