...
namespace Amazon.S3.Model
{
    ...
    public class CopyObjectRequest : S3Request
    {
        ...
        {
            get { return this.sourceBucket; }
            set { this.sourceBucket = value; }
        }
        ...
        /// want to copy.
        /// </summary>
        /// <param name="sourceBucket">The value that SourceBucket is set to</param>
        /// <returns>the response with the SourceBucket set</returns>
        public CopyObjectRequest WithSourceBucket(string sourceBucket)
        {
        ...
        {
            return !System.String.IsNullOrEmpty(this.sourceBucket);
        }
        ...
        /// </summary>
        /// <param name="sourceKey">The value that SourceKey is set to</param>
        ...
        {
            return !System.String.IsNullOrEmpty(this.sourceKey);
        }
        ...
        /// <returns></returns>
        public CopyObjectRequest WithMetaData(Dictionary<string, string> metaInfo)
        {
            ...
            if (metaData == null)
            {
                metaData = new Dictionary<string, string>(metaInfo.Count);
            }

            foreach (KeyValuePair<String, String> meta in metaInfo)
            {
        ...
        {
            get { return this.sourceVersionId; }
            set { this.sourceVersionId = value; }
        }
        ...
        /// </summary>
        /// <param name="sourceVersionId">The value that SourceVersionId is set to</param>
        /// <returns>this instance</returns>
        ...
        {
            return !System.String.IsNullOrEmpty(this.sourceVersionId);
        }
        ...
        /// information on S3 Storage Classes.
        /// </summary>
        /// <param name="storageClass">The Storage Class to be set on the object</param>
        /// <returns>The request with the StorageClass set</returns>
        public CopyObjectRequest WithStorageClass(S3StorageClass storageClass)
        {
