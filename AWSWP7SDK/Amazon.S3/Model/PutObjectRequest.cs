...
namespace Amazon.S3.Model
{
    ...
    public class PutObjectRequest : S3Request
    {
        ...
        private bool generateMD5Digest;
        ...
        {
            get { return this.generateMD5Digest; }
            set { this.generateMD5Digest = value; }
        }
        ...
        /// </summary>
        /// <param name="generateMD5Digest">GenerateMD5Digest property</param>
        /// <returns>this instance</returns>
        ...
        /// </remarks>
        public PutObjectRequest WithGenerateChecksum(bool generateMD5Digest)
        {
            this.generateMD5Digest = generateMD5Digest;
            return this;
        }
        ...
        /// <returns></returns>
        public PutObjectRequest WithMetaData(Dictionary<string, string> metaInfo)
        {
        ...
        public PutObjectRequest WithStorageClass(S3StorageClass storageClass)
        {
