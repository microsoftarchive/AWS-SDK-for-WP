...
namespace Amazon.S3.Model
{
    ...
    [XmlRootAttribute(Namespace = "http://s3.amazonaws.com/doc/2006-03-01/", IsNullable = false, ElementName = "CopyObjectResult")]
    public class CopyObjectResponse : S3Response
    {
        ...
        public override System.Net.WebHeaderCollection Headers
        {
            set
            {
                ...
                string hdr = null;
                if (!System.String.IsNullOrEmpty(hdr = value["x-amz-copy-source-version-id"]))
                {
